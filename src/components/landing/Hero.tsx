    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-cream to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 lg:pt-28 lg:pb-32">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.h1
            className="mt-4 font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-navy leading-tight text-balance"
            {...fadeUp}
          ...
          <motion.p
            className="mt-6 text-lg sm:text-xl text-navy/60 leading-relaxed max-w-2xl mx-auto"
            {...fadeUp}
        ...
        >
          {[
            ...
            >
              <p className="font-display text-3xl font-bold text-coral">{item.stat}</p>
              <p className="mt-1 text-sm text-navy/60">{item.label}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
